...
const About = () => {
  return (
    <section className="max-container bg-gray-900 text-gray-200">
      ...
      <div className="py-16">
        <h3 className="subhead-text text-gray-100">Education & Skill</h3>
        <p className="mt-5 flex flex-col gap-3 text-gray-400">
          Front-end developer with a solid foundation in HTML, CSS, JavaScript, and React.js. Skilled at transforming design mockups into responsive, user-friendly web applications. Demonstrates hands-on experience through a portfolio of academic projects and selfinitiated endeavors, showcasing attention to detail and commitment to excellence. Motivated to launch a career within a collaborative team environment, eager to contribute to innovative projects and leverage cuttingedge technologies. Dedicated to continuous learning and staying current with the latest industry trends and best practices to deliver top-tier web solutions.
        </p>
      </div>
